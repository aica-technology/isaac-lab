...
class DifferentialIKControllerCfg:
    ...
    command_type: Literal["position", "pose", "velocity", "linear_velocity"] = MISSING
    ...
    If "linear_velocity", the controller controls the linear velocity of of the articulation's body while keep 
    orientation as is.
    """
    ...
    def __post_init__(self):
        # check valid input
        if self.command_type not in ["position", "pose", "velocity", "linear_velocity"]:
