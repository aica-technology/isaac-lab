...
class UniformForcePoseCommand(CommandTerm):
    ...
    def _resample_command(self, env_ids: Sequence[int]):
        ...
        self.pose_command_b[env_ids, 7] = r.uniform_(*self.cfg.ranges.force_x)
        self.pose_command_b[env_ids, 8] = r.uniform_(*self.cfg.ranges.force_y)
        self.pose_command_b[env_ids, 9] = r.uniform_(*self.cfg.ranges.force_z)
